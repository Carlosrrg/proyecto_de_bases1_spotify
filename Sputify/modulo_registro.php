...
<html lang="es" xmlns:og="http://ogp.me/ns#" xmlns:fb="https://www.facebook.com/2008/fbml" class="layout-signup ">
  ...
  <head>
      ...
      <script>
        (function(window, document) {
            ...
            as.async = true;
            as.src = 'extra/sp-analytics.e31149242b518e1475e6.js';
  ...
  <body class="page-signup  m-hn l-es page-signup is-loggedout  reboot ">
                              ...
                              <section class="register">
                                  <div class="content">
                                      ...
                                      <form id="js-register-with-email" method="post" action="" novalidate="novalidate">
                                          ...
                                          <input type="hidden" id="signup_form_data_source" name="signup_form[data_source]" value="www">
                                          <div class="js-general-error alert alert-info hidden" data-error="¡Vaya! Algo ha salido mal. Inténtalo de nuevo o visita nuestra &lt;a href=&quot;/help/&quot;&gt;área de ayuda&lt;/a&gt;.">
                                          </div>
                                          <input type="hidden" id="signup_form_sp_csrf" name="signup_form[sp_csrf]" value="">
                                          <input type="hidden" id="signup_form_creation_flow" name="signup_form[creation_flow]">
                                          <input type="hidden" id="forward-url-parameter" name="signup_form[forward_url_parameter]">
                                          <input type="hidden" id="register-pre-tick-eula" name="signup_form[signup_pre_tick_eula]" value="true">
                                          <fieldset>
                                              <ul>
                                                  <li class="">
                                                      ...
                                                      <input type="email" id="register-email" name="signup_form[email]" required="required" maxlength="100" placeholder="Email" data-msg-email="La dirección de email que proporcionaste no es válida." data-msg-remote="Lo sentimos, este correo ya está registrado." data-msg-required="Por favor introduce tu email.">
                                                  </li>
                                                  <li class="">
                                                      <label class="sr-only required" for="register-confirm-email">
                                                        Confirmar email
                                                      </label>
                                                      <input type="email" id="register-confirm-email" name="signup_form[confirm_email]" required="required" maxlength="100" placeholder="Confirmar email" data-msg-email="La dirección de email que proporcionaste no es válida." data-msg-equalto="La dirección de email no coincide." data-msg-required="Por favor introduce tu email." data-rule-equalto="#register-email">
                                                  </li> 
                                                  <li class="">
                                                      <label class="sr-only required" for="register-password">
                                                        Contraseña
                                                      </label>
                                                      <input type="password" id="register-password" name="signup_form[password]" required="required" autocomplete="off" maxlength="100" placeholder="Contraseña" data-msg-minlength="Tu contraseña es demasiado corta." data-msg-required="Por favor elige una contraseña." data-rule-minlength="4" aria-autocomplete="list">
                                                  </li>
                                                  <li class="">
                                                      <label class="sr-only required" for="register-displayname">
                                                        Nombre
                                                      </label>
                                                      <input type="text" id="register-displayname" name="signup_form[displayname]" required="required" autocapitalize="off" autocorrect="off" autocomplete="off" maxlength="30" placeholder="¿Cómo te llamas?" data-msg-required="¿Cómo te llamas?">
                                                  </li>
                                                  <li id="li-dob" class="controls-dob" data-error-age="Lo sentimos, pero no cumples con la edad que Spotify requiere.">
                                                      ...
                                                      <div id="register-dob" class="register-dob">
                                                          <div class="controls controls-day">
                                                              <input type="number" id="register-dob-day" name="signup_form[dob_day]" required="required" max="31" maxlength="2" min="1" pattern="[0-9]*" placeholder="día" class="dob" data-msg-required="Por favor introduce un día válido del mes." data-msg-number="Por favor introduce un día válido del mes." data-msg-min="Por favor introduce un día válido del mes." data-msg-max="Por favor introduce un día válido del mes." data-msg-maxlength="Por favor introduce un día válido del mes.">
                                                          </div>
                                                          <div class="controls controls-month">
                                                              <select id="register-dob-month" name="signup_form[dob_month]" required="required" class="dob" data-msg-required="Por favor introduce tu mes de nacimiento.">
                                                          ...
                                                          <div class="controls controls-year">
                                                              <input type="number" id="register-dob-year" name="signup_form[dob_year]" required="required" min="1900" max="2005" maxlength="4" pattern="[0-9]*" placeholder="año" class="dob" data-msg-required="Por favor introduce un año válido." data-msg-number="Por favor introduce un año válido." data-msg-min="Por favor introduce un año válido." data-msg-max="Lo sentimos, pero no cumples con la edad que Spotify requiere." data-msg-maxlength="Por favor introduce un año válido.">
                                                          </div>
                                                      </div>
                                                  </li>
                                                  <li id="li-gender" class="gender">
                                                      ...
                                                      <label for="register-male" class="radio control-inline">
                                                        <input type="radio" id="register-male" name="signup_form[gender]" required="required" class="gender" data-msg-required="Por favor indica tu género." value="male">
                                                        Masculino
                                                      </label>
                                                      <label for="register-female" class="radio control-inline">
                                                        <input type="radio" id="register-female" name="signup_form[gender]" required="required" class="gender" data-msg-required="Por favor indica tu género." value="female">
                                                        Femenino
                                                      </label>
                                                      <label for="register-neutral" class="radio control-inline">
                                                          <input type="radio" id="register-neutral" name="signup_form[gender]" required="required" value="neutral">
                                                          No binario
                                                      </label>
                                                  </li>
                                          ...
                                          <a href="#" id="register-button-email-submit" class="btn btn-green btn-block js-signup-email-submit">
                                              Registrarse
                                          </a>
                                      </form>
                                    ...
                                    <p class="primary">
                                      ...
                                      <a id="register-link-login" data-section="login" data-tracking="{&quot;category&quot;: &quot;Registration&quot;, &quot;action&quot;: &quot;signup-form-login-link&quot;}" href="iniciar_seccion.html">
                                        Iniciar sesión
                                      </a>
                                    </p>
                                  </div>
        ...
        <script src="extra/spweb-site.min.0b2587fc95c8490ee7c3.js.download"></script>    
        <script src="extra/signup.06ec1a2efdfb9eb873c1.js.download"></script>  
        <script async="" src="extra/vt-150.js.download"></script>
          

        <iframe name="_hjRemoteVarsFrame" title="_hjRemoteVarsFrame" id="_hjRemoteVarsFrame" src="extra/rcj-da10bd4908deb9e19dfde013ec3fe4ff.html" style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;">  
        </iframe>
        ...
        <div style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px; position: absolute; transition: visibility 0s linear 0.3s, opacity 0.3s linear 0s; opacity: 0; visibility: hidden; z-index: 2000000000; left: 0px; top: -10000px;">
          ...
          <div style="z-index: 2000000000; position: relative;">
            <iframe title="Reto recaptcha" src="extra/bframe.html" name="c-3bbj2kpg0jwt" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox" style="width: 100%; height: 100%;"></iframe>
          </div>
        </div>
