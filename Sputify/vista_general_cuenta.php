            ...
            <div class="content-wrapper">
                  <style>
                      ...
                      @media (max-width: 767px) {
                                .container-promotion {
                                    background-image: url('img/escritorio_pequeno.png');
                                    background-size: 100% auto;
                                }
                      }
                  </style>

                  <div class="container container-jumbotron container-promotion holiday">
                      <div class="jumbotron jumbotron-hero jumbotron-inverse ">
                          <div class="row">
                              <div class="col-sm-7 col-lg-6 col-lg-offset-1">
                                    <h2 class="h1">Obtén 3 meses de Premium por 0.99&nbsp;USD.</h2>
                                    <p>
                                    ...
                                    <p class="terms">
                                        Sujeto a restricciones. La oferta termina el 12-31-2018. Aplican 
                                        <a href="#">
